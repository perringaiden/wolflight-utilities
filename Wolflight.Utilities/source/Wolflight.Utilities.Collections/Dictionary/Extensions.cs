T﻿namespace Wolflight.Utilities.Collections.Dictionary
{
    /// <summary>
    ...
    public static class Extensions
    {
        ...
        public static void AddSetValue<TKey, TValue>(this IDictionary<TKey, ISet<TValue>> dictionary, TKey key, TValue value)
        {
					...
					public static void AddSetValues<TKey, TValue>(this IDictionary<TKey, ISet<TValue>> dictionary, TKey key, IEnumerable<TValue> value)
					{
        ...
        /// <param name="value">The value to remove.</param>
					...
					/// </returns>
					public static bool RemoveSetValue<TKey, TValue>(this IDictionary<TKey, ISetValue<TValue>> dictionary, TKey key, TValue value)
					{
        ...
        /// <param name="key">The key of the set.</param>
					...
					internal static ISet<TValue> GetValues<TKey, TValue>(this IDictionary<TKey, ISet<TValue>> dictionary, TKey key)
					{
							if (!dictionary.TryGetValue(key, out ISet<TValue>? items))
							{
